...
<button data-modal-target="member-modal-{id}" data-modal-toggle="member-modal-{id}" class="block text-start flex space-x-2 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700" style="width: 100%;">
    ...
    <p class="text-2xl font-semibold text-gray-700 dark:text-gray-200 my-auto">{name}</p>
</button>
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                ...
                <p class="text-base font-medium text-gray-500 dark:text-gray-400 mt-6 mb-2">
                  Public Key:
                </p>
                <div class="flex items-start mt-0 mb-2" style="max-width: 100%;">
                  <p
                    class="text-xl font-medium text-gray-700 dark:text-gray-200 {pubkey_truncate_status} my-auto"
