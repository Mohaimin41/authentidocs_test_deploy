        ...
        <div class="tab-item-data">
          ...
          {:else if tabs[1].active}
              ...
              <div class="flex justify-end mt-2">
                  <button on:click={() => {create_thread_modal.show();}} type="button" disabled={!is_member} class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 mx-2 mb-2">Create Thread</button>
              </div>
