    ...
    {#if data_loaded}
      <div class="details" in:fade={{duration: 250}}>
        ...
        <div class="grid grid-cols-4 mb-4">
            <p class="text-xl font-medium text-gray-500 dark:text-gray-400 mb-2">Created At</p>
            <p class="text-xl font-medium text-gray-500 dark:text-gray-400 mb-2">Sender</p>
            <p class="text-xl font-medium text-gray-500 dark:text-gray-400 mb-2">Notifier Type</p>
            <p class="text-xl font-medium text-gray-500 dark:text-gray-400 mb-2">Notifier Entity</p>
            ...
            <div class="flex items-center">
              <svg class="w-6 h-6 text-green-500 dark:text-green-400 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                ...
                <p class="text-base font-medium text-gray-700 dark:text-gray-200 me-1">{type_map.get(notice_level)}</p>
            </div>
            <div class="flex items-center">
        ...
        <p class="text-xl font-medium text-gray-500 dark:text-gray-400 mb-2">Content</p>
      </div>
