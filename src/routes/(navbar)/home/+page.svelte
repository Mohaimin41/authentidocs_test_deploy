        ...
        {#if tab_index === 0}
            <div class="list-container m-6">
                ...
                <div class="list-upload flex justify-end">
                    <button on:click={show_modal} type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 m-0 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Upload</button>
                </div>
            </div>
        {:else if tab_index === 1}
            <div class="list-container m-6">
            ...
            <div class="p-4 md:p-5 space-y-4">            
                <div class="flex items-center justify-center w-full">
                    <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                        ...
                        <input bind:this={file_input_elem} id="dropzone-file" type="file" class="hidden" />
                    </label>
                </div> 
            </div>
        </div>
