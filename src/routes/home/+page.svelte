<script lang="ts">
    ...
    let color0: string = "bg-white dark:bg-gray-800";
    let color1: string = "bg-white dark:bg-gray-800";
    let color2: string = "bg-white dark:bg-gray-800";
    let color3: string = "bg-white dark:bg-gray-800";
    let color4: string = "bg-white dark:bg-gray-800";

    function reset_color(): void
    {
        color0 = "bg-white dark:bg-gray-800";
        color1 = "bg-white dark:bg-gray-800";
        color2 = "bg-white dark:bg-gray-800";
        color3 = "bg-white dark:bg-gray-800";
        color4 = "bg-white dark:bg-gray-800";
    }
    ...
    [
        {
            ...
            callback: (): void =>
            {
                ...
                color0 = "bg-gray-200 dark:bg-gray-600";
                tab_index = 0;
            }
        },
        {
            ...
            callback: (): void =>
            {
                ...
                color1 = "bg-gray-200 dark:bg-gray-600";
                tab_index = 1;
            }
        },
        {
            ...
            callback: (): void =>
            {
                ...
                color2 = "bg-gray-200 dark:bg-gray-600";
                tab_index = 2;
            }
        },
        {
            ...
            callback: (): void =>
            {
                ...
                color3 = "bg-gray-200 dark:bg-gray-600";
                tab_index = 3;
            }
        },
        {
            ...
            callback: (): void =>
            {
                ...
                color4 = "bg-gray-200 dark:bg-gray-600";
                tab_index = 4;
            }
        }
    ];
    ...
    let arch_threads: Thread[] = new Array(3);
        ...
        {#if tab_index === 0}
            <div class="list-container m-6">
                ...
                <ul class="list-elements space-y-2 pb-2" style="overflow-y: auto;">
                    <li>
                        <FileCard file_name={"File 1"} file_type={"jpg"} />
                    </li>
                    <li>
                        <FileCard file_name={"File 2"} file_type={"png"} />
                    </li>
                    <li>
                        <FileCard file_name={"File 3"} file_type={"pdf"} />
                    </li>
                </ul>
            </div>
        {:else if tab_index === 1}
