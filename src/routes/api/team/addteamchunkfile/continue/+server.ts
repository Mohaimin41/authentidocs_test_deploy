...
export async function POST({
  ...
  if (filename === null) {
    console.log(
      "ERROR @api/team/addteamchunkfile/continue:21: url parameter filename returned null"
    );
    get(filemap).clear();
  ...
  if (
    ...
    console.log(
      "ERROR @api/team/addteamchunkfile/continue:35: request json null||undefined or has incorrect body"
    );
    get(filemap).clear();
    return json({ success: false });
  }
